...
export default function EditProfileScreen() {
  ...
  const validateForm = () => {
    ...
    const { phone, streetAddress, postalCode, city } = formData;
  ...
  const handleSave = async () => {
    ...
    const trimmedEmail = formData.email.trim();
    console.log('Updating user email to', JSON.stringify(trimmedEmail));
    ...
    console.log('Updating auth email to', JSON.stringify(trimmedEmail));
