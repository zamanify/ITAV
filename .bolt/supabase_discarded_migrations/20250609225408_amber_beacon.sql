/*
  # Complete Request System Refactor

  1. Schema Changes
    - Remove group_id column from requests table
    - Create request_groups junction table for multiple groups per request
    - Create request_villagers junction table for multiple villagers per request

  2. Security Changes
    - Update all RLS policies to work with new junction tables
    - Ensure proper access control for the new structure

  3. Performance
    - Add indexes for optimal query performance
*/

-- First, remove the group_id column from requests table
